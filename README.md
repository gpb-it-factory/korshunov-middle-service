...
Middle-level принимает запросы от телеграм-бота. 
Валидирует данные, занимается бизнес-логикой, отправляет запросы на backend-level. 
Более точный принцип работы смотри ниже :arrow_down:
